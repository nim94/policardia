    ...
    <div class="container">
        <div class="row la_policardia">
            ...
            <div class="col-sm-12 col-md-6 section_title_container left"> 
                <a href="{!! get_permalink($post_policardia) !!}"><h2 class="section_title left">{{ $post_policardia->post_title }}</h2></a>
        ...
        <div class="row la_compagnia">
            ...
            <div class="col-sm-12 col-md-6 section_toggle_desktop">
                <a href="{!! get_permalink($post_policardia) !!}"><h2 class="section_title right">{{ $post_policardia->post_title }}</h2></a>
            </div>
            <div class="col-sm-12 col-md-6 slider">
                <div class="owl-carousel owl-theme owl-carousel-home">
                    <div class="item"><img src="{{get_stylesheet_directory_uri()}}\assets\images\policardia\policardi4.png" alt=""></div>
            ...
            <div class="col-sm-12 col-md-6 section_title_container right"> 
                <a href="{!! get_permalink($post_policardia) !!}" class="section_toggle_mobile"><h2 class="section_title right">{{ $post_policardia->post_title }}</h2></a>
