        ...
        <div class="center-content">
            ...
            <div class="row spettacoli">
                <div class="spettacoli_button col-sm-12 col-md-6">
                    <a href="#"><img src="{{get_stylesheet_directory_uri()}}\assets\images\policardia\policardi4.png" alt="Spettacoli" class="bw width-250"></a>
                </div>
            ...
            <div class="slider-compagnia">
                <div class="owl-carousel owl-theme owl-carousel-home">
                    ...
                    @endphp
                    <div class="item"><img src="{{get_stylesheet_directory_uri()}}\assets\images\policardia\policardi4.png" alt="" class="width-250"></div>
                    <div class="item"><img src="{{get_stylesheet_directory_uri()}}\assets\images\policardia\policardi4.png" alt="" class="width-250"></div>
                    <div class="item"><h4>4</h4></div>
                    <div class="item"><h4>5</h4></div>
                    <div class="item"><h4>6</h4></div>
