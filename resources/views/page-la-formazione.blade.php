    ...
    <div class="container">
        <div class="center-content">
            ...
            <div class="row end_page_buttons end_page_buttons_formazione">
                ...
                <div class="col-sm-12 col-md-4">
                    <a href="{!! get_permalink( get_page_by_path( 'la-formazione/laboratorio-di-teatro' ) ) !!}"></a>
                </div>
                <div class="col-sm-12 col-md-4">
                    <a href="{!! get_permalink( get_page_by_path( 'la-formazione/progetti-nel-sociale' )->ID ) !!}"></a>
                </div>
            </div>
